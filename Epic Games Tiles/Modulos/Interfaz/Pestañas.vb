...
Namespace Interfaz
    Module Pestañas
        ...
        Public Sub Visibilidad(gridMostrar As Grid, tag As String, origen As Object)
            ...
            tbTitulo.Text = recursos.GetString("Epic_Title") + " (" + Package.Current.Id.Version.Major.ToString + "." + Package.Current.Id.Version.Minor.ToString + "." + Package.Current.Id.Version.Build.ToString + "." + Package.Current.Id.Version.Revision.ToString + ")"
            ...
            Dim gridContactarAñadirJuegos As Grid = pagina.FindName("gridContactarAñadirJuegos")
