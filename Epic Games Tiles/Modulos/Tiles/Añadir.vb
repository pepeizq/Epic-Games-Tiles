...
Namespace Tiles
    Module Añadir
        ...
        Public Async Sub Generar(tile As Tile)
            ...
            Await Imagen.Generar(gridTilePequeña, tile.IDEpic + "pequena.png", 71, 71)

            Dim gridTileMediana As Grid = pagina.FindName("gridTileMediana")
            Await Imagen.Generar(gridTileMediana, tile.IDEpic + "mediana.png", 150, 150)

            Dim gridTileAncha As Grid = pagina.FindName("gridTileAncha")
            Await Imagen.Generar(gridTileAncha, tile.IDEpic + "ancha.png", 310, 150)

            Dim gridTileGrande As Grid = pagina.FindName("gridTileGrande")
            Await Imagen.Generar(gridTileGrande, tile.IDEpic + "grande.png", 310, 310)

            '-----------------------

            Dim nuevaTile As New SecondaryTile(tile.IDEpic, tile.Titulo, tile.Enlace, New Uri("ms-appdata:///local/" + tile.IDEpic + "ancha.png", UriKind.RelativeOrAbsolute), Windows.UI.StartScreen.TileSize.Wide310x150)

            nuevaTile.VisualElements.Square71x71Logo = New Uri("ms-appdata:///local/" + tile.IDEpic + "pequena.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Square150x150Logo = New Uri("ms-appdata:///local/" + tile.IDEpic + "mediana.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Wide310x150Logo = New Uri("ms-appdata:///local/" + tile.IDEpic + "ancha.png", UriKind.RelativeOrAbsolute)
            nuevaTile.VisualElements.Square310x310Logo = New Uri("ms-appdata:///local/" + tile.IDEpic + "grande.png", UriKind.RelativeOrAbsolute)
            ...
            Dim fondoImagenMediano As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDEpic + "mediana.png",
            ...
            Dim fondoImagenAncha As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDEpic + "ancha.png",
                .HintCrop = AdaptiveImageCrop.Default
            }
            ...
            Dim fondoImagenGrande As New TileBackgroundImage With {
                .Source = "ms-appdata:///local/" + tile.IDEpic + "grande.png",
                .HintCrop = AdaptiveImageCrop.Default
            }
            ...
            Try
                TileUpdateManager.CreateTileUpdaterForSecondaryTile(tile.IDEpic).Update(notificacion)
